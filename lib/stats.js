...
var STATS = (function () {
    ...
    var pingNow = function () {
        ...
        var subs = require("./background").get_subscriptions_minus_text();
        var pingData = "cmd=ping" +
            ...
            "&o=" + os +
            "&bv=" + browserVersion +
            "&ad=" + (require("./background").get_settings().show_advanced_options ? '1': '0') +
        ...
        if (subs["acceptable_ads"]) {
          pingData += "&aa=" + (subs["acceptable_ads"].subscribed ? '1' : '0');
        } else {
          pingData += "&aa=u";
        }
