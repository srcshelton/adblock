...
_myFilters.init();
if (typeof exports !== 'undefined') exports._myFilters = _myFilters;
            ...
            if (contentWin) {
                ...
                if (selectedTab) {
                    ...
                    if (blocked && (canPurge > 0)) {
                        ...
                        var data = { command: "purge-elements", frameUrl: frameUrl, tabId: tabId, url:aContentLocation.spec, elType: elType};
                        port.chrome.extension.sendRequest(data);
                    }
                }
            } else {
                functions.log("content window null / not found");
                return Ci.nsIContentPolicy.ACCEPT;
            }
...
if (typeof exports !== 'undefined') exports.page_is_whitelisted = page_is_whitelisted;