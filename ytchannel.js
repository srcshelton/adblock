...
function updateURL(channelName, shouldReload) {
  ...
  chrome.runtime.sendMessage(null, { command: 'updateYouTubeChannelName', args: channelName });
...
{
  if (msg.type === 'reloadYouTube') {
    location.reload();
    sendResponse({});
  } else if (msg.type === 'whitelistAllYouTubeChannels') {
