...
$(function () {
    ...
    BG.getCurrentTabInfo(function (info) {
        ...
        if (paused) {
          ...
          $('#block_counts_help').
          toggle(settings.show_block_counts_help_link).
          click(function () {
        ...
        if (!settings.show_advanced_options || !tab.id)
    ...
    $('#div_whitelist_channel').click(function () {
        ...
        // ReloadTab doesn't seem to work in Edge on YT.com, so we'll send a message to the content script
        chrome.tabs.sendMessage(tab.id, { type: 'reloadYouTube' });
        closeAndReloadPopup();
      });
